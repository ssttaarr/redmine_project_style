...
Redmine::Plugin.register :redmine_project_style do
  ...
  description 'Allows to set a visual style per project using project identifier. (cloned from redmine_projectstyle and modified to make it compatible with latest version of redmine)'
  version '3.0'
